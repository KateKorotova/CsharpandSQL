...
namespace WorkwithDB {
    ...
    public partial class MyDatabaseDataSet1 : global::System.Data.DataSet {
        ...
        public partial class OrganizationDataTable : global::System.Data.TypedTableBase<OrganizationRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public OrganizationRow AddOrganizationRow(System.DateTime Дата, string Организация, string Город, string Страна, string Менеджер, int Количество, decimal Сумма) {
            ...
            private void InitClass() {
                ...
                this.columnОрганизация.MaxLength = 10;
                ...
                this.columnМенеджер.MaxLength = 10;
        ...
        public partial class OrganizationRow : global::System.Data.DataRow {
            ...
            public System.DateTime Дата {
                get {
                    return ((global::System.DateTime)(this[this.tableOrganization.ДатаColumn]));
                }
                set {
                    this[this.tableOrganization.ДатаColumn] = value;
                }
            }
            ...
            public string Организация {
                get {
                    return ((string)(this[this.tableOrganization.ОрганизацияColumn]));
                }
                set {
                    this[this.tableOrganization.ОрганизацияColumn] = value;
                }
            }
            ...
            public string Город {
                get {
                    return ((string)(this[this.tableOrganization.ГородColumn]));
                }
                set {
                    this[this.tableOrganization.ГородColumn] = value;
                }
            }
            ...
            public string Страна {
                get {
                    return ((string)(this[this.tableOrganization.СтранаColumn]));
                }
                set {
                    this[this.tableOrganization.СтранаColumn] = value;
                }
            }
            ...
            public string Менеджер {
                get {
                    return ((string)(this[this.tableOrganization.МенеджерColumn]));
                }
                set {
                    this[this.tableOrganization.МенеджерColumn] = value;
                }
            }
            ...
            public int Количество {
                get {
                    return ((int)(this[this.tableOrganization.КоличествоColumn]));
                }
                set {
                    this[this.tableOrganization.КоличествоColumn] = value;
                }
            }
            ...
            public decimal Сумма {
                get {
                    return ((decimal)(this[this.tableOrganization.СуммаColumn]));
                }
                set {
                    this[this.tableOrganization.СуммаColumn] = value;
                }
            }
        }
...
namespace WorkwithDB.MyDatabaseDataSet1TableAdapters {
    ...
    public partial class OrganizationTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Organization] WHERE (([Id] = @Original_Id) AND ([Дата] = @Original_Дата) AND ([Организация] = @Original_Организация) AND ([Город] = @Original_Город) AND ([Страна] = @Original_Страна) AND ([Менеджер] = @Original_Менеджер) AND ([Количество] = @Original_Количество) AND ([Сумма] = @Original_Сумма))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Сумма", global::System.Data.SqlDbType.Decimal, 0, global::System.Data.ParameterDirection.Input, 13, 2, "Сумма", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Organization] ([Дата], [Организация], [Город], [Страна], [Менеджер], [Количество], [Сумма]) VALUES (@Дата, @Организация, @Город, @Страна, @Менеджер, @Количество, @Сумма);
SELECT Id, Дата, Организация, Город, Страна, Менеджер, Количество, Сумма FROM Organization WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Сумма", global::System.Data.SqlDbType.Decimal, 0, global::System.Data.ParameterDirection.Input, 13, 2, "Сумма", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Organization] SET [Дата] = @Дата, [Организация] = @Организация, [Город] = @Город, [Страна] = @Страна, [Менеджер] = @Менеджер, [Количество] = @Количество, [Сумма] = @Сумма WHERE (([Id] = @Original_Id) AND ([Дата] = @Original_Дата) AND ([Организация] = @Original_Организация) AND ([Город] = @Original_Город) AND ([Страна] = @Original_Страна) AND ([Менеджер] = @Original_Менеджер) AND ([Количество] = @Original_Количество) AND ([Сумма] = @Original_Сумма));
SELECT Id, Дата, Организация, Город, Страна, Менеджер, Количество, Сумма FROM Organization WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Сумма", global::System.Data.SqlDbType.Decimal, 0, global::System.Data.ParameterDirection.Input, 13, 2, "Сумма", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Сумма", global::System.Data.SqlDbType.Decimal, 0, global::System.Data.ParameterDirection.Input, 13, 2, "Сумма", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WorkwithDB.Properties.Settings.Default.MyDatabaseConnectionString;
        }
        ...
        public virtual int Fill(MyDatabaseDataSet1.OrganizationDataTable dataTable) {
        ...
        public virtual MyDatabaseDataSet1.OrganizationDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            MyDatabaseDataSet1.OrganizationDataTable dataTable = new MyDatabaseDataSet1.OrganizationDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(MyDatabaseDataSet1.OrganizationDataTable dataTable) {
        ...
        public virtual int Insert(System.DateTime Дата, string Организация, string Город, string Страна, string Менеджер, int Количество, decimal Сумма) {
        ...
        public virtual int Update(
            ...
            if ((Original_Организация == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(Original_Организация));
            }
            if ((Original_Город == null)) {
                throw new global::System.ArgumentNullException("Original_Город");
            }
        ...
        public virtual int Update(System.DateTime Дата, string Организация, string Город, string Страна, string Менеджер, int Количество, decimal Сумма, int Original_Id, System.DateTime Original_Дата, string Original_Организация, string Original_Город, string Original_Страна, string Original_Менеджер, int Original_Количество, decimal Original_Сумма) {
            return this.Update(Дата, Организация, Город, Страна, Менеджер, Количество, Сумма, Original_Id, Original_Дата, Original_Организация, Original_Город, Original_Страна, Original_Менеджер, Original_Количество, Original_Сумма, Original_Id);
        }
    }
